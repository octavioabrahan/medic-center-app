          ...
          {loading ? (
            ...
            <div className="admin-citas-agendadas__table-container">
              <Table 
                ...
                columnWidths={["40px", "auto", "auto", "auto", "auto", "auto", "auto", "auto"]}
                renderCustomCell={(row, column, colIndex) => {
                  ...
                  if (column === "iconoEmpresa") {
                    return (
                      <div className="empresa-cell" style={{ width: '40px', minWidth: '40px', maxWidth: '40px' }}>
                        {row.id_empresa && (
                          <div className="empresa-icon" title="Agendamiento con convenio">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="building-icon" style={{ width: '24px', height: '24px' }}>
